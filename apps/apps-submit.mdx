...
<Tabs>
  ...
  <Tab title="Approval">
    ...
    <Check>
    Your post will be tagged as **"Accepted"** and your app will be automatically uploaded to the Onboarding App Library!
    </Check>
  ...
  <Tab title="External Apps">
    ...
    If your app doesn't meet the requirements for the official library, you can still distribute it:
    
    - Post as an **External App**
    - Your post will be tagged as **"External"**
    - Users can download it manually
    - No official integration with Onboarding
    
    <Warning>
    External apps don't receive the official Flare Studio verification badge.
    </Warning>
  </Tab>
</Tabs>
...
```mdx
<!-- Discord #apps channel -->
<Frame>
  <img src="/images/apps/discord-apps-channel.png" alt="Discord Apps Channel" />
</Frame>

<!-- Submission post example -->
<Frame>
  <img src="/images/apps/submission-example.png" alt="Example Submission Post" />
</Frame>

<!-- Accepted tag -->
<Frame>
  <img src="/images/apps/accepted-tag.png" alt="Accepted App Tag" />
</Frame>
```
