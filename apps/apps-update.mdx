...
<Steps>
  ...
  <Step title="Select Model Category">
    ...
    <Frame caption="Select Model as the asset category">
      <img src="/images/apps/asset-category-model.png" alt="Asset Category Selection" />
    </Frame>
  </Step>
...
<Frame>
  <img src="/images/apps/asset-category-model.png" alt="Select Model Category" />
</Frame>

<!-- Overwrite option location -->
<Frame>
  <img src="/images/apps/overwrite-option.png" alt="Overwrite Existing Asset Option" />
</Frame>

<!-- Asset selection list -->
<Frame>
  <img src="/images/apps/select-asset.png" alt="Select Asset to Overwrite" />
</Frame>

<!-- Update success confirmation -->
<Frame>
  <img src="/images/apps/update-success.png" alt="Update Successful" />
</Frame>
```
